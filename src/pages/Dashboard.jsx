    ...
    return (
        <div className="page" style={{ paddingTop: 0 }}>
            <header className="topbar">
                <div className="title"><img src={logo} alt="AI Shooter Icon" className="app-icon" /> AI Shooter</div>
                <div className="signin">
                    {user ? (
                        <>
                            <div className="credits">
                                <span className="credit-count">{credits != null ? credits : 0} <span className="desktop-only">Credits</span></span>
                                    ...
                                    <div className="getmore-panel">
                                        ...
                                        <div className="getmore-icons">
                                            <a className="icon-link tiktok" href="https://www.tiktok.com/@ai_shooter_bot" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
                                                <img src="https://www.tiktok.com/favicon.ico" alt="TikTok" style={{ width: 24, height: 24 }} />
                                            </a>
